jQuery(function ($) {
    $('#lpagery_save_settings').on('click', function (e) {
        ...
        var settings_payload = {
            ...
            'settings': {
                ...
                'consistent_update': $('#lpagery_consistent-update-enabled').is(':checked'),
                ...
                'google_sheet_sync_type': $('#lpagery_google_sync_type').val(),
    ...
    jQuery.ajax({
        ...
        "success": function (response) {
            ...
            $('#lpagery_consistent-update-enabled').prop('checked', JSON.parse(parsed.consistent_update))
            ...
            $('#lpagery_google_sync_type').val(parsed.google_sheet_sync_type).change()
            let now = new Date(),
