<div class="Main lpagery-container-without-sidebar" data-title="History">
    <div id="lpagery-extended-overlay-manage">
        <div class="lpagery-overlay-content">
            <h2>Upgrade Required</h2>
            <p>These features are only available for Extended and higher plans. Upgrade now to unlock more powerful
                features.</p>
            <ul>
                <li>Manage the created pages</li>
                <li>Bulk Update and Delete</li>
                <li>Google Sheet Sync</li>
                <li>Interlink the created pages</li>
                <li></li>
                <li>And more!</li>
            </ul>
    ...
    <div class="license-needed license-needed-fadeout" data-license="extended" id="lpagery_history_container_div"
