...
<div class="Main lpagery-container-with-sidebar" data-title="Welcome to LPagery" style="text-align: center">
    ...
    <div class=" license-needed" data-license="extended" id="lpagery_create_update_switch_container">
...
?></option>
            ...
            <div id="lpagery_parent-section" class="license-needed" data-license="standard">
...
?></option>
            ...
            <div data-license="standard" id="lpagery_slug-section" class="license-needed">
            ...
            <div data-license="standard" id="lpagery_category-section" class="license-needed">
...
?>
            ...
            <div data-license="standard" id="lpagery_tags-section" class="license-needed">
...
?>
            ...
            <div data-license="standard" id="lpagery_status-section" class="license-needed">
            ...
            <div data-license="standard" id="lpagery_publish_date-section" class="license-needed" style="margin-top: 25px">
            ...
            <div id="lpagery_update_existing_data">
                <div id="lpagery_update_existing_data_radio" data-license="standard"
...
?>">
            ...
            <div id="lpagery_modeRadio" style="min-height: 180px">
                <div id="lpagery_input-radio" data-license="standard" class="lpagery_radio-buttons license-needed">
                    <h3 id="lpagery_input-heading">
                        7. What input do you want to use?
                        <img style="width: 40px; top: -100px;" class="img-pro"  data-license="extended"
                             src="<?php 
echo plugin_dir_url( dirname( __FILE__ ) ) . '/../assets/img/pro.svg';
?>">
